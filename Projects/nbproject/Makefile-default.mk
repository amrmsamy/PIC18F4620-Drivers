...
SOURCEFILES_QUOTED_IF_SPACED=ECU_Layer/LED/ECU_led.c MCAL_Layer/GPIO/hal_gpio.c MCAL_Layer/decive_config.c application.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/ECU_Layer/LED/ECU_led.p1 ${OBJECTDIR}/MCAL_Layer/GPIO/hal_gpio.p1 ${OBJECTDIR}/MCAL_Layer/decive_config.p1 ${OBJECTDIR}/application.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/ECU_Layer/LED/ECU_led.p1.d ${OBJECTDIR}/MCAL_Layer/GPIO/hal_gpio.p1.d ${OBJECTDIR}/MCAL_Layer/decive_config.p1.d ${OBJECTDIR}/application.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/ECU_Layer/LED/ECU_led.p1 ${OBJECTDIR}/MCAL_Layer/GPIO/hal_gpio.p1 ${OBJECTDIR}/MCAL_Layer/decive_config.p1 ${OBJECTDIR}/application.p1

# Source Files
SOURCEFILES=ECU_Layer/LED/ECU_led.c MCAL_Layer/GPIO/hal_gpio.c MCAL_Layer/decive_config.c application.c
...
${OBJECTDIR}/MCAL_Layer/decive_config.p1: MCAL_Layer/decive_config.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/MCAL_Layer" 
	@${RM} ${OBJECTDIR}/MCAL_Layer/decive_config.p1.d 
	@${RM} ${OBJECTDIR}/MCAL_Layer/decive_config.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gcoff -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/MCAL_Layer/decive_config.p1 MCAL_Layer/decive_config.c 
	@-${MV} ${OBJECTDIR}/MCAL_Layer/decive_config.d ${OBJECTDIR}/MCAL_Layer/decive_config.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/MCAL_Layer/decive_config.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
