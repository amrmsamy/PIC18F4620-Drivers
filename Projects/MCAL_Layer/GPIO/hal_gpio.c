...
{
    Std_ReturnType ret = E_OK;
    if(NULL == _pin_config || NULL == directio_status || _pin_config->pin > PORT_PIN_MAX_NUMBER-1)
    {
        Std_ReturnType ret = E_NOK;
    }
    else
    {
        *directio_status = READ_BIT(*tris_registers[_pin_config->port], _pin_config->pin);
    }
    return ret;
}
#endif
...
{
    Std_ReturnType ret = E_OK;
    if(NULL == _pin_config || _pin_config->port > PORT_PIN_MAX_NUMBER-1)
    {
        Std_ReturnType ret = E_NOK;
    }
    else
